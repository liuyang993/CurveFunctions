...
int main()
{
	...
	series1.push_back(1.0);
	series1.push_back(2.0);
	series1.push_back(3.0);
	series1.push_back(4.0);

    UnivariateTimeSeries ts1(series1);
    
	std::vector<double> series2;
	series2.push_back(0.0);
	series2.push_back(-1.0);
	series2.push_back(5.0);
	series2.push_back(2.5);
