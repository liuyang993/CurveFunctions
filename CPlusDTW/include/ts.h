...
public:
    ...
    // Move semantics
    TimeSeriesBase(const TimeSeriesBase&);
    TimeSeriesBase(TimeSeriesBase&&);
    virtual TimeSeriesBase& operator=(const TimeSeriesBase&) = 0;
    virtual TimeSeriesBase& operator=(TimeSeriesBase&&) = 0;
    virtual ~TimeSeriesBase() = 0;
